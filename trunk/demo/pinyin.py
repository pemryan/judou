...
PinYinDict = dict([( ord(k.decode('utf-8')), '|'.join([pv.decode('utf-8') for pv in v])) for k, v in PinYinDict.items()])

def hanzi2pinyin(hanzi):
    """ hanzi should be unicode string"""
    assert type(hanzi) is types.UnicodeType
    pinyin = ''
    for char in hanzi:
        char_ord = ord(char)
...
if __name__ == '__main__':
    try:
        print hanzi2pinyin('亟')
    except AssertionError:
        pass
    print hanzi2pinyin('亟'.decode('utf8'))
